...
function teamNameFunction() {
	...
	document.getElementById("cap_name_question").innerHTML =
		"Who is the Team Captain of " + x + "?";
	document.getElementById("name_question_1").innerHTML =
		"Who is the next Team Member of " + x + "?";
	document.getElementById("name_question_2").innerHTML =
		"Who is the next Team Member of " + x + "?";
	document.getElementById("name_question_3").innerHTML =
		"Who is the next Team Member of " + x + "?";
}

function capNameFunction() {
	var y = document.getElementById("capName").value;
	document.getElementById("cap_email_question").innerHTML =
		"What is " + y + "'s email address?";
	document.getElementById("cap_parent_email_question").innerHTML =
		"What is " + y + "'s parent's email address?";
	document.getElementById("cap_grade_question").innerHTML =
		"What grade is " + y + " in?";
	document.getElementById("cap_gender_question").innerHTML =
		"What is " + y + "'s gender?";
	document.getElementById("cap_dietary_question").innerHTML =
		"What dietary restrictions does " + y + " have?";
	document.getElementById("cap_school_question").innerHTML =
		"What school does " + y + " go to?";
}

function capSchoolFunction() {
	var z = document.getElementById("capSchool").value;
	document.getElementById("cap_school_us_question").innerHTML =
		"Is " + z + " located in the US?";
	document.getElementById("cap_school_state_question").innerHTML =
		"Which state is " + z + " located in?";
...
function oneNameFunction() {
	...
	document.getElementById("email_question_1").innerHTML =
		"What is " + b + "'s email address?";
	document.getElementById("parent_email_question_1").innerHTML =
		"What is " + b + "'s parent's email address?";
	document.getElementById("grade_question_1").innerHTML =
		"What grade is " + b + " in?";
	document.getElementById("gender_question_1").innerHTML =
		"What is " + b + "'s gender?";
	document.getElementById("dietary_question_1").innerHTML =
		"What dietary restrictions does " + b + " have?";
	document.getElementById("school_question_1").innerHTML =
		"What school does " + b + " go to?";
}

function oneSchoolFunction() {
	var c = document.getElementById("School1").value;
	document.getElementById("school_us_question_1").innerHTML =
		"Is " + c + " located in the US?";
	document.getElementById("school_state_question_1").innerHTML =
		"Which state is " + c + " located in?";
...
function twoNameFunction() {
	...
	document.getElementById("email_question_2").innerHTML =
		"What is " + e + "'s email address?";
	document.getElementById("parent_email_question_2").innerHTML =
		"What is " + e + "'s parent's email address?";
	document.getElementById("grade_question_2").innerHTML =
		"What grade is " + e + " in?";
	document.getElementById("gender_question_2").innerHTML =
		"What is " + e + "'s gender?";
	document.getElementById("dietary_question_2").innerHTML =
		"What dietary restrictions does " + e + " have?";
	document.getElementById("school_question_2").innerHTML =
		"What school does " + e + " go to?";
}

function twoSchoolFunction() {
	var f = document.getElementById("School2").value;
	document.getElementById("school_us_question_2").innerHTML =
		"Is " + f + " located in the US?";
	document.getElementById("school_state_question_2").innerHTML =
		"Which state is " + f + " located in?";
...
function threeNameFunction() {
	...
	document.getElementById("email_question_3").innerHTML =
		"What is " + h + "'s email address?";
	document.getElementById("parent_email_question_3").innerHTML =
		"What is " + h + "'s parent's email address?";
	document.getElementById("grade_question_3").innerHTML =
		"What grade is " + h + " in?";
	document.getElementById("gender_question_3").innerHTML =
		"What is " + h + "'s gender?";
	document.getElementById("dietary_question_3").innerHTML =
		"What dietary restrictions does " + h + " have?";
	document.getElementById("school_question_3").innerHTML =
		"What school does " + h + " go to?";
}

function threeSchoolFunction() {
	var i = document.getElementById("School3").value;
	document.getElementById("school_us_question_3").innerHTML =
		"Is " + i + " located in the US?";
	document.getElementById("school_state_question_3").innerHTML =
		"Which state is " + i + " located in?";
...
$(document).ready(function () {
	...
	document
		.getElementById("capSchoolUS_yes")
		.addEventListener("click", function () {
			showQuestion();
		});
	document
		.getElementById("capSchoolUS_no")
		.addEventListener("click", function () {
			hideQuestion();
		});
...
$(document).ready(function () {
	...
	var input = document.getElementById("school-div");
	document
		.getElementById("SchoolUS1_yes")
		.addEventListener("click", function () {
			showQuestion1();
		});
	document
		.getElementById("SchoolUS1_no")
		.addEventListener("click", function () {
			hideQuestion1();
		});
...
$(document).ready(function () {
	...
	var input = document.getElementById("school-div");
	document
		.getElementById("SchoolUS2_yes")
		.addEventListener("click", function () {
			showQuestion2();
		});
	document
		.getElementById("SchoolUS2_no")
		.addEventListener("click", function () {
			hideQuestion2();
		});
...
$(document).ready(function () {
	...
	var input = document.getElementById("school-div");
	document
		.getElementById("SchoolUS3_yes")
		.addEventListener("click", function () {
			showQuestion3();
		});
	document
		.getElementById("SchoolUS3_no")
		.addEventListener("click", function () {
			hideQuestion3();
		});
...
$(document).ready(function () {
	$("#money-hidden-question").hide();
	document
		.getElementById("payment_type_paypal")
		.addEventListener("click", function () {
			showMoneyQuestion();
		});
	document
		.getElementById("payment_type_zelle")
		.addEventListener("click", function () {
			showMoneyQuestion();
		});

	function showMoneyQuestion() {
		$("#money-hidden-question").show();
	}
});
...
document
	...
	.addEventListener("input", inputOneValidationFunction);
...
document
	...
	.addEventListener("input", inputTwoValidationFunction);
...
document
	.getElementById("cap_email")
	.addEventListener("input", inputThreeValidationFunction);
document
	.getElementById("capParentEmail")
	.addEventListener("input", inputThreeValidationFunction);
document
	.getElementById("capGrade")
	.addEventListener("input", inputThreeValidationFunction);
...
document
	.getElementById("capGender_male")
	.addEventListener("click", inputFourValidationFunction);
document
	.getElementById("capGender_female")
	.addEventListener("click", inputFourValidationFunction);
document
	.getElementById("capGender_other")
	.addEventListener("click", inputFourValidationFunction);
document
	.getElementById("capSchool")
	.addEventListener("input", inputFourValidationFunction);
...
document
	.getElementById("capSchoolUS_yes")
	.addEventListener("click", inputFiveValidationFunction);
document
	.getElementById("capSchoolUS_no")
	.addEventListener("click", inputFiveValidationFunction);
...
document
	...
	.addEventListener("input", inputSixValidationFunction);
...
document
	...
	.addEventListener("input", inputSevenValidationFunction);
document
	.getElementById("ParentEmail1")
	.addEventListener("input", inputSevenValidationFunction);
document
...
document
	.getElementById("Gender_1_male")
	.addEventListener("click", inputEightValidationFunction);
document
	.getElementById("Gender_1_female")
	.addEventListener("click", inputEightValidationFunction);
document
	.getElementById("Gender_1_other")
	.addEventListener("click", inputEightValidationFunction);
document
	.getElementById("School1")
	.addEventListener("input", inputEightValidationFunction);
...
document
	.getElementById("SchoolUS1_yes")
	.addEventListener("click", inputNineValidationFunction);
document
	.getElementById("SchoolUS1_no")
	.addEventListener("click", inputNineValidationFunction);
...
document
	...
	.addEventListener("input", inputTenValidationFunction);
...
document
	...
	.addEventListener("input", inputElevenValidationFunction);
document
	.getElementById("ParentEmail2")
	.addEventListener("input", inputElevenValidationFunction);
document
...
document
	.getElementById("Gender_2_male")
	.addEventListener("click", inputTwelveValidationFunction);
document
	.getElementById("Gender_2_female")
	.addEventListener("click", inputTwelveValidationFunction);
document
	.getElementById("Gender_2_other")
	.addEventListener("click", inputTwelveValidationFunction);
document
	.getElementById("School2")
	.addEventListener("input", inputTwelveValidationFunction);
...
document
	.getElementById("SchoolUS2_yes")
	.addEventListener("click", inputThirteenValidationFunction);
document
	.getElementById("SchoolUS2_no")
	.addEventListener("click", inputThirteenValidationFunction);
...
document
	...
	.addEventListener("input", inputFourteenValidationFunction);
...
document
	...
	.addEventListener("input", inputFifteenValidationFunction);
document
	.getElementById("ParentEmail3")
	.addEventListener("input", inputFifteenValidationFunction);
document
...
document
	.getElementById("Gender_3_male")
	.addEventListener("click", inputSixteenValidationFunction);
document
	.getElementById("Gender_3_female")
	.addEventListener("click", inputSixteenValidationFunction);
document
	.getElementById("Gender_3_other")
	.addEventListener("click", inputSixteenValidationFunction);
document
	.getElementById("School3")
	.addEventListener("input", inputSixteenValidationFunction);
...
document
	.getElementById("capSchoolUS_yes")
	.addEventListener("click", submitOneValidationFunction);
document
	.getElementById("capSchoolUS_no")
	.addEventListener("click", submitOneValidationFunction);
...
document
	.getElementById("SchoolUS1_yes")
	.addEventListener("click", submitTwoValidationFunction);
document
	.getElementById("SchoolUS1_no")
	.addEventListener("click", submitTwoValidationFunction);
...
document
	.getElementById("SchoolUS2_yes")
	.addEventListener("click", submitThreeValidationFunction);
document
	.getElementById("SchoolUS2_no")
	.addEventListener("click", submitThreeValidationFunction);
...
document
	.getElementById("SchoolUS3_yes")
	.addEventListener("click", submitFourValidationFunction);
document
	.getElementById("SchoolUS3_no")
	.addEventListener("click", submitFourValidationFunction);
...
function moneyTotalFunction() {
	if ((team_member_count == 1)) {
		document.getElementById("money-total-question").innerHTML = "$10";
	} else if ((team_member_count == 2)) {
		document.getElementById("money-total-question").innerHTML = "$20";
	} else if ((team_member_count == 3)) {
		document.getElementById("money-total-question").innerHTML = "$30";
	} else if ((team_member_count == 4)) {
		document.getElementById("money-total-question").innerHTML = "$30";
	} else {
		document.getElementById("money-total-question").innerHTML =
			"Your team member count does not meet the requirements. Please go back and ensure your team consists of 1 to 4 team members.";
	}
}

document.addEventListener("DOMContentLoaded", moneyFunction);
function moneyFunction() {
	if ((team_member_count == 1)) {
		document.getElementById("money-question").innerHTML = "1";
	} else if ((team_member_count == 2)) {
		document.getElementById("money-question").innerHTML = "2";
	} else if ((team_member_count == 3)) {
		document.getElementById("money-question").innerHTML = "3";
	} else if ((team_member_count == 4)) {
		document.getElementById("money-question").innerHTML = "4";
	} else {
		document.getElementById("money-question").innerHTML =
			"Your team member count does not meet the requirements. Please go back and ensure your team consists of 1 to 4 team members.";
	}
}
...
document
	.getElementById("payment_type_paypal")
	.addEventListener("click", questionChangeFunction);
document
	.getElementById("payment_type_zelle")
	.addEventListener("click", questionChangeFunction);
function questionChangeFunction() {
	const PayPal = document.getElementById("payment_type_paypal");
	const Zelle = document.getElementById("payment_type_zelle");
	if (PayPal.checked) {
		document.getElementById("payment_info").innerHTML =
			"Click the Paypal button below to complete your payment. Please type in the first and last name associated with your PayPal payment.";
	} else if (Zelle.checked) {
		document.getElementById("payment_info").innerHTML =
			"Click the Zelle button below to complete your payment. Send your money to 978-806-1538. Please type in email associated with your Zelle payment.";
	}
}

const finalSubmitButton = document.getElementById("official-submit-btn");
document
	.getElementById("payment_type_paypal")
	.addEventListener("click", revealSubmit);
document
	.getElementById("payment_type_zelle")
	.addEventListener("click", revealSubmit);
document.getElementById("payment_contact").addEventListener("input", revealSubmit);
function revealSubmit() {
	var PayPalCheck = document.getElementById("payment_type_paypal");
	var ZelleCheck = document.getElementById("payment_type_zelle");
	var PaymentInput = document.getElementById("payment_info").value;
	if (PaymentInput === "") {
		finalSubmitButton.disabled = true;
	} else if (PayPalCheck.checked) {
		finalSubmitButton.disabled = false;
	} else if (ZelleCheck.checked) {
		finalSubmitButton.disabled = false;
	}
}
